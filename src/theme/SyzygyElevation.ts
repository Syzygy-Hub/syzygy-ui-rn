export interface SyzygyElevationLevel {
  shadowColor: string;
...
export interface SyzygyElevation {
  none: SyzygyElevationLevel;
  sm: SyzygyElevationLevel;
  md: SyzygyElevationLevel;
  lg: SyzygyElevationLevel;
}
export const defaultElevation: SyzygyElevation = {
